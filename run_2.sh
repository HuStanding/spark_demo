spark-submit \
    ...
    --conf spark.yarn.dist.archives=hdfs://ns-fed/user/aisearch/user/huzhuo002/tools/python2.zip#python \
    --conf spark.pyspark.driver.python=/home/huzhuo002/anaconda3/envs/python2/bin/python \
